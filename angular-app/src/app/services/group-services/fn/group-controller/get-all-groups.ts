...
export function getAllGroups(http: HttpClient, rootUrl: string, params?: GetAllGroups$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<GroupDto>>> {
